            ...
            <div className="absolute inset-0 flex flex-col justify-center p-4">
              <div className="flex flex-col gap-2 items-start">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="button"
                    className="btn-yellow py-1.5 px-4 rounded-xl font-bold text-xs flex items-center gap-1 shadow"
                  >
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-wrap gap-2">
              {['Action', 'Dark Fantasy', 'Supernatural', 'School', 'Adventure'].map((genre) => (
                <span
                  key={genre}
                  className="bg-[var(--genre-pill)] text-[var(--purple-darker)] px-4 py-1.5 rounded-full text-[16px] font-semibold"
                >
                  {genre}
                </span>
              ))}
